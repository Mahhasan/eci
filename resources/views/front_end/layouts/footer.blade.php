                            ...
                            <div class="footer-content">
                                <div class="footer-head">
                                    ...
                                    <ul class="footer-list">
                                        ...
                                        <li><a href="http://bida.gov.bd/">BIDA</a></li>
                                        ...
                                        <li><a href="https://nbr.gov.bd/">NBR</a></li>
                                    </ul>
                                    <ul class="footer-list hidden-sm">
										
                                        
                                        <li><a href="https://ictd.gov.bd/">ICT Division</a></li>
                                        <li><a href="https://www.startupbangladesh.vc/">Startup Bangladesh Limited</a></li>
                                        <li><a href="https://idea.gov.bd/">Innovation Design and Entrepreneurship Academy</a></li>
                                        <li><a href="https://www.adb.org/countries/bangladesh/contacts">Asian Development Bank</a></li>
                                        <li><a href="https://www.worldbank.org/en/country/bangladesh">The World Bank</a></li>
									</ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="footer-content last-content">
                                <div class="footer-head">
                                    ...
                                    <div class="footer-icons">
                                        <ul>
                                            <li>
                                                <a href="https://www.facebook.com/Enterprise-Competitiveness-Institute-ECI-162600325898628/">
                                                    <i class="fa fa-facebook"></i>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="https://twitter.com/InstituteEci">
