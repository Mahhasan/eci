							...
							<div class="single-service wow fadeInUp" data-wow-delay="0.7s">
								...
								<div class="service-inner">
									<div class="service-content">
										...
										<a class="service-btn" href="{{url('/report-publication/global')}}"><i class="ti-arrow-right"></i></a>
									</div>
								</div>
							</div>
                        </div>
							...
							<div class="single-service wow fadeInUp" data-wow-delay="0.3s">
								...
								<div class="service-inner">
									<div class="service-content">
										...
										<a class="service-btn" href="{{url('/report-publication/sectoral-report')}}"><i class="ti-arrow-right"></i></a>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="single-service wow fadeInUp" data-wow-delay="0.5s">
								...
								<div class="service-inner">
									<div class="service-content">
										...
										<a class="service-btn" href="{{url('report-publication/diu-publication')}}"><i class="ti-arrow-right"></i></a>
									</div>
								</div>
							</div>
						</div>
