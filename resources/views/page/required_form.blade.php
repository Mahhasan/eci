							...
							<div class="single-service wow fadeInUp" data-wow-delay="0.3s">
								...
								<div class="service-inner">
									<div class="service-content">
                                        ...
                                        <a class="service-btn" href="{{url('/single-window/required-forms/agriculturul_development')}}"><i class="ti-arrow-right"></i></a>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="single-service wow fadeInUp" data-wow-delay="0.5s">
								...
								<div class="service-inner">
									<div class="service-content">
										...
										<p>Aspernatur sit adipisci quaerat unde at neque Redug Lagre dolor sit amet consectetu. independent agency, free from the internal demands.</p>
										<a class="service-btn" href="{{url('/single-window/required-forms/business_tred')}}"><i class="ti-arrow-right"></i></a>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="single-service wow fadeInUp" data-wow-delay="0.7s">
								...
								<div class="service-inner">
									<div class="service-content">
										...
										<a class="service-btn" href="{{url('/single-window/required-forms/ict_development')}}"><i class="ti-arrow-right"></i></a>
									</div>
								</div>
							</div>
                        </div>
							...
							<div class="single-service wow fadeInUp" data-wow-delay="0.3s">
								...
								<div class="service-inner">
									<div class="service-content">
										...
										<p>Aspernatur sit adipisci quaerat unde at neque Redug Lagre dolor sit amet consectetu. independent agency, free from the internal demands.</p>
										<a class="service-btn" href="{{url('/single-window/required-forms/science-innovation')}}"><i class="ti-arrow-right"></i></a>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="single-service wow fadeInUp" data-wow-delay="0.5s">
								...
								<div class="service-inner">
									<div class="service-content">
										...
										<a class="service-btn" href="{{url('/single-window/required-forms/sme-development')}}"><i class="ti-arrow-right"></i></a>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="single-service wow fadeInUp" data-wow-delay="0.7s">
								...
								<div class="service-inner">
									<div class="service-content">
										...
										<a class="service-btn" href="{{url('/single-window/required-forms/taxation')}}"><i class="ti-arrow-right"></i></a>
									</div>
								</div>
							</div>
						</div>
