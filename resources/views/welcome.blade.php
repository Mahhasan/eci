@include('front_end.layouts.header')
        ...
        <div class="intro-area">
            <div class="bg-wrapper">
            	<img src="front_end/img/background/slider1.jpg" alt="">
            </div>
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="layer-1 wow fadeInUp" data-wow-delay="0.3s">
                                    ...
                                    <h2 class="title2" style="color: white;">
                                        Endeavor towards
                                    <span class="color"> Sustainable </span>
                                    Development
                                    </h2>
								</div>
								<!-- layer 2 -->
								<div class="layer-2 wow fadeInUp" data-wow-delay="0.5s">
									<p>Linkage with Global Players</p>
								</div>
								<!-- layer 3 -->
								<div class="layer-3 wow fadeInUp" data-wow-delay="0.7s">
									<a href="{{url('/single-window/')}}" class="ready-btn left-btn " >Single Window</a>
									<a href="{{url('/contact')}}" class="ready-btn right-btn" target="_blank">Contact us</a>
								</div>
							</div>
						</div>
					</div>
            ...
            <div class="container-full">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <marquee behavior="" onmouseover="this.stop();" onmouseout="this.start();" style="background-color: #5168DD" width="auto" height="40">
                            <p style="color:white;"><b>
                                 <a href="http://campustv.ac/" style="color:white;" target="_blank">Webinar on 'Effect of Non-Tariff Measures in Trade between Bangladesh and India' on 13 July, 2021 at 11:30 a.m. Live on Campus TV</a>
							...
							<div class="single-service wow fadeInUp" data-wow-delay="0.3s">
								...
								<div class="service-inner">
									<div class="service-content">
										<h4>Single Window for the Development (SW4D)</h4>
										<p>Single Window is being used to describe a multitude of different platforms, systems and environments.
                                            </p>
                                        <a class="service-btn" href="{{url('/single-window')}}"><i class="ti-arrow-right"></i></a>
									</div>
								</div>
							</div>
						</div>
        ...
        <!-- Start project Area -->
        <div class="project-area area-padding partner">
            <div class="container">
                <div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12 ">
						<div class="section-headline text-center">
							<h3>Our successful Partnership</h3>
                    ...
                    <div class="project-carousel">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <div class="single-awesome-project">
                                <!-- <div class="awesome-img">
                                    <a href="#">
                                        <img src="front_end/img/project/p1.jpg" alt="" />
                                    </a>
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            ...
                            <div class="single-awesome-project">
                                <!-- <div class="awesome-img">
                                    <a href="#">
                                        <img src="front_end/img/partner/itc.png" alt="" />
                                    </a>
                                    <div class="add-actions text-center">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            ...
                            <div class="single-awesome-project">
                                <!-- <div class="awesome-img">
                                    <a href="#">
                                        <img src="front_end/img/project/p4.jpg" alt="" />
                                    </a>
                                    <div class="add-actions text-center">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            ...
                            <div class="single-awesome-project">
                                <!-- <div class="awesome-img">
                                    <a href="#">
                                        <img src="front_end/img/project/p5.jpg" alt="" />
                                    </a>
                                    <div class="add-actions text-center">
							...
							<div class="tab-pane active" id="p-view-1" >
								<div class="tab-inner">
									<div class="single-machine row">
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <div class="tabe-img">
                                                <img src="front_end/img/services/s1.jpg" alt="">
                                            </div>
										</div>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
							...
							<div class="tab-pane" id="p-view-2">
								<div class="tab-inner">
									<div class="single-machine row">
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <div class="tabe-img">
                                                <img src="front_end/img/services/s2.jpg" alt="">
                                            </div>
										</div>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <div class="machine-text">
							...
							<div class="tab-pane" id="p-view-3">
								<div class="tab-inner">
									<div class="single-machine row">
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <div class="tabe-img">
                                                <img src="front_end/img/services/s3.jpg" alt="">
                                            </div>
										</div>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <div class="machine-text">
