...
class DataController extends Controller
{
    ...
    public function required_form(){
        return view('page.required_form');
    }
    ...
    public function newsletter_may(){
        return view('newsletter.newsletter_may');
    }
    public function newsletter_june(){
        return view('newsletter.newsletter_june');
    }
    public function newsletter_july(){
        return view('newsletter.newsletter_july');
    } 
    public function newsletter_august(){
        return view('newsletter.newsletter_august');
    }
    
    public function newsletter_september(){
        return view('newsletter.newsletter_september');
    }
    public function newsletter_october(){
        return view('newsletter.newsletter_october');
    }
    public function newsletter_november(){
        return view('newsletter.newsletter_november');
    }
    public function newsletter_december(){
        return view('newsletter.newsletter_december');
    }
    public function newsletter_march(){
        return view('newsletter.newsletter_march_2022');
    }
